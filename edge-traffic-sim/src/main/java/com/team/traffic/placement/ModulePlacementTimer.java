...
public class ModulePlacementTimer extends ModulePlacementMapping {
  public ModulePlacementTimer(List<FogDevice> fog, Application app, TopologyBuilder.Topo topo) {
